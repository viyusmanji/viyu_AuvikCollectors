...
export default function DocFeedback({
  ...
  const handleSubmitSuggestion = () => {
    ...
    const issueTitle = `Documentation suggestion: ${pageTitle}`;
    const issueBody = `**Page:** ${pageUrl}\n\n**Suggestion:**\n\n${suggestion || '[Please describe your suggestion here]'}\n\n---\n*This issue was created from the documentation feedback form.*`;
        ...
        {githubRepo && (
          <>
            <button
              ...
              className={styles.toggleSuggestionButton}
              aria-label={showSuggestionForm ? 'Hide suggestion form' : 'Show suggestion form'}
            ...
            >
              ...
              <span className={styles.buttonLabel}>
                {showSuggestionForm ? 'Hide suggestion form' : 'Share a suggestion'}
              </span>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className={`${styles.chevronIcon} ${showSuggestionForm ? styles.chevronIconExpanded : ''}`}
              >
            ...
            {showSuggestionForm && (
              <div className={styles.suggestionForm} role="region" aria-label="Suggestion form">
                <label htmlFor="suggestion-textarea" className={styles.suggestionLabel}>
                ...
                <textarea
                  ...
                  placeholder="Share your ideas for improving this documentation..."
                  aria-describedby="suggestion-help"
                />
                <p id="suggestion-help" className={styles.suggestionHelp}>
                  Your suggestion will be used to create a GitHub issue.
                </p>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className={styles.buttonLabel}>Submit suggestion</span>
                </button>
              </div>
            )}
